const CACHE = 'biblio-shell-v38';
const ASSETS = ['/', '/style.css?v=library-home-v1', '/app.js?v=library-home-v1', '/api.js?v=library-home-v1', '/manifest.webmanifest', '/icon.svg', '/brand/reverendo-albert-banner.png', '/brand/reverendo-albert-boas-vindas.png'];
